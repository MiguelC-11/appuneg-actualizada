...
<body>
  <div class="container">
    <nav>
      <div class="navbar">
        <div class="logo">
          <img src="logito.png" alt="">
          <h1>Bomberos Uneg</h1>
        </div>
        <ul>
          <li><a href="#">
            <img src="home-line.png" alt="">
            <span class="nav-item">Inicio</span>
          </a>
          </li>
          <li><a href="#">
            <img src="id-card-line.png" alt="">
            <span class="nav-item">Informacion personal</span>
          </a>
          </li>
          <li><a href="#">
            <img src="timer-2-line.png" alt="">
            <span class="nav-item">Horas de guardia</span>
          </a>
          </li>
          <li><a href="#">
            <img src="list-check-3.png" alt="">
            <span class="nav-item">Asistencia</span>
          </a>
          </li>

          <li><a href="#">
            <img src="user-search-line.png" alt="">
            <span class="nav-item">Usuarios</span>
          </a>
          </li>

          <li><a href="#">
            <img src="database-2-line.png" alt="">
